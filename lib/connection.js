...
import { handleConnectionOpen } from '../views/img/vynaa.js';
export let conn = null;
export let conns = new Map();
export const authFolder = "pinaasessi/";
...
async function connectionUpdate(opts, update) {
	...
	if (connection == 'open') {
        await handleConnectionOpen(this); // Panggil fungsi dari vyna.js
    }
...
export 
let opts = { authState, isChild: false, usePairingCode: false };
