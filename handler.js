...
// batas 
    ...
    if (!user.premium && !user.vip) {
        return this.sendMessage(m.chat, {
            text: '```🚩 Akses Bot Ke Private Chat Di Tolak, Silahkan Upgrade Premium Hanya 3000Idr Agar Bisa Bebas Akses Bot Dengan Hubungi Owner :\nwa.me/6282389924037\n\n• Join Ke Group Official Bot Untuk Free Akses & Informasi Kedepannya Tentang Bot : https://chat.whatsapp.com/Dm4vM3jXN9mFg9cR4pkYNa```',
            contextInfo: {
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        unreg: 'ꜱɪʟᴀᴋᴀɴ ᴅᴀꜰᴛᴀʀ ᴋᴇ ᴅᴀᴛᴀʙᴀꜱᴇ ʙᴏᴛ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ, ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ, ᴋᴇᴛɪᴋ *.daftar namamu* ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀꜰᴛᴀʀ.'
    }[type]
